...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalog', '0002_inventorylog_productreview_reviewhelpful_wishlist_and_more'),
        ('orders', '0001_initial'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_percentage', models.PositiveIntegerField(verbose_name='% giảm giá')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_limit', models.PositiveIntegerField(default=0, verbose_name='Số lượng giới hạn')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_value', models.PositiveIntegerField(verbose_name='Giá trị giảm (% hoặc VND)')),
                ('max_discount', models.PositiveIntegerField(default=0, verbose_name='Giảm tối đa (VND)')),
                ('min_order_value', models.PositiveIntegerField(default=0, verbose_name='Giá trị đơn hàng tối thiểu (VND)')),
                ('total_quantity', models.PositiveIntegerField(default=0, verbose_name='Tổng số lượng')),
                ('used_quantity', models.PositiveIntegerField(default=0, verbose_name='Đã sử dụng')),
                ('usage_limit_per_user', models.PositiveIntegerField(default=1, verbose_name='Giới hạn sử dụng mỗi user')),
                ...
                ('applicable_categories', models.ManyToManyField(blank=True, to='catalog.category', verbose_name='Áp dụng cho danh mục')),
                ('applicable_products', models.ManyToManyField(blank=True, to='catalog.productmodel', verbose_name='Áp dụng cho sản phẩm')),
            ],
            options={
